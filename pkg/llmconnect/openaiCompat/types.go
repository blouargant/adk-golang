...
func (e StatusError) Error() string {
	...
	default:
		...
		return "something went wrong, please see the openaiCompat server logs for details"
	}
}
...
type GenerateRequest struct {
	// Model is the model name; it should be a name familiar to openaiCompat from
	// the library at https://openaiCompat.com/library
